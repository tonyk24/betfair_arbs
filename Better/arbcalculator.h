#ifndef ARBCALCULATOR_H
#define ARBCALCULATOR_H
...
public:
  ...
  void chooseBets(const BfEvent &event,
  ...
  void findTwoCombinations(EventStats *m_eventStats,
                           const BfEvent &event,
                                       const std::list<BetfairMarket> &markets,
  ...
  static int m_currentArbBetId;
};

#endif // ARBCALCULATOR_H
